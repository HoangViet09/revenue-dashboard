                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    <div className="bg-blue-50 p-4 rounded-lg">
                                        ...
                                        <p className="text-2xl font-bold text-blue-900">
                                            $
                                            {dashboardData.revenue?.summary?.totalRevenue?.toLocaleString()}
                                        </p>
                                        <p className="text-sm text-blue-600">
                                            {
                                                dashboardData.revenue.summary
                                                    ?.totalDays
                                            }{" "}
                                            days
                                        </p>
                                    ...
                                    <div className="bg-green-50 p-4 rounded-lg">
                                        ...
                                        <p className="text-2xl font-bold text-green-900">
                                            $
                                            {dashboardData.revenue.summary?.averagePerDay.toLocaleString()}
                                        </p>
                                    ...
                                    <div className="bg-orange-50 p-4 rounded-lg">
                                        ...
                                        <p className="text-2xl font-bold text-orange-900">
                                            $
                                            {dashboardData.revenue.summary?.highestDay.revenue.toLocaleString()}
                                        </p>
                                                    ...
                                                    {revenueData?.data?.map(
                                                        (row) => (
                                                            <tr key={row.date}>
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                                    $
                                                                    {row.posRevenue.toFixed(
                                                                        2
                                                                    )}
                                                                </td>
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                                    $
                                                                    {row.eatclubRevenue.toFixed(
                                                                        2
                                                                    )}
                                                                </td>
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                                    $
                                                                    {row.labourCosts.toFixed(
                                                                        2
                                                                    )}
                                                                </td>
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                                    $
                                                                    {row.totalRevenue.toFixed(
                                                                        2
                                                                    )}
                                                                </td>
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                                    $
                                                                    {row.netRevenue.toFixed(
                                                                        2
                                                                    )}
                                                                </td>
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
            ...
            <RevenueModal
                ...
                onSubmit={
                    editingRevenue
                        ...
                        : handleSaveRevenueData
                }
                title={
                    editingRevenue ? "Edit Revenue Data" : "Add Revenue Data"
                }
